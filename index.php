...
if (filter_input(INPUT_POST, "btnEntrar", FILTER_SANITIZE_STRING)) {
    ...
    if ($resultado != null) {
        ...
        if ($resultado->getStatus() == 'A'){
            if (filter_input(INPUT_POST, "ckManterLogado", FILTER_SANITIZE_STRING)) {
                $_SESSION["entrar"] = true;
            }
            $_SESSION["cod"] = $resultado->getId();
            $_SESSION["nome"] = $resultado->getLogin();
            $_SESSION["permissao"] = $resultado->getPermissao();
            $_SESSION["logado"] = true;
            header("Location: painel.php?pagina=visualizarusuario&id=".$resultado->getId());
            ...
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <br />
                        <label><a href="cadastrarUsuario.php">Novo Cadastro</a></label>  
